...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const order = new index_1.newebpay.agreement.AgreementOrder({
            orderNo,
            amount: 100,
            orderInfo: '訂閱服務首期',
        ...
        yield fs.writeFile(node_path_1.default.join('.', 'demo-agreement.html'), (0, generate_html_form_1.generateHtmlForm)(applyResult));
