...
class TokenUnbind {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield axios_1.default.post(env.tokenUnbindApiUrl, body.toString(), { headers: { 'content-type': 'application/x-www-form-urlencoded' } });
...
exports.TokenUnbind = TokenUnbind;
