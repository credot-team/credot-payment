...
declare type KeyofPaymentTypes = keyof typeof PaymentTypes;
/**
 * @version v1.1.1
 * 支付請求結構
 *
...
declare type TradeInfo<PayMethod extends PayMethods | unknown> = {
    /**
     * 回傳狀態
     *
     * - 若交易付款成功，則回傳 SUCCESS。
 ...
 */
declare type Result<PayMethod extends PayMethods | unknown> = GeneralFields & (PayMethod extends PayMethods.Credit | PayMethods.CreditInst | PayMethods.CreditReward | PayMethods.SamsungPay | PayMethods.GooglePay | PayMethods.ApplePay | PayMethods.UnionPay ? CreditCardFields : PayMethod extends PayMethods.WebATM | PayMethods.VACC ? ATMFields : PayMethod extends PayMethods.CVS ? CVSCodeFields : PayMethod extends PayMethods.CVSBarcode ? CVSBarcodeFields : PayMethod extends PayMethods.CVSCOM ? CVSCOMFields : PayMethod extends PayMethods.ezPay | PayMethods.ezPay_Wechat | PayMethods.ezPay_Alipay ? CrossBorderFields : PayMethod extends PayMethods.EsunWallet ? EsunWalletFields : PayMethod extends PayMethods.TaiwanPay ? TaiwanPayFields : Partial<CreditCardFields> & Partial<CVSCodeFields> & Partial<CVSBarcodeFields> & Partial<CVSCOMFields> & Partial<CrossBorderFields> & Partial<EsunWalletFields> & Partial<TaiwanPayFields>);
/**
 * 所有支付方式共同回傳參數
 */
declare type GeneralFields = {
    /**
     * 藍新金流商店代號
     */
    MerchantID: string;
 ...
 */
declare type CrossBorderFields = {
    /**
     * 跨境通路類型
     *
     * 該筆交易之跨境收款通路。
